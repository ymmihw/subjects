...
public class NumberWordConverterUnitTest {
  ...
  public void whenMoneyNegative_thenReturnInvalidInput() {
    assertEquals(NumberWordConverter.INVALID_INPUT_GIVEN,
        NumberWordConverter.getMoneyIntoWords(-13));
  }
  ...
  public void whenTwoBillionDollarsGiven_thenReturnWords() {
    String expectedResult =
        "two billion one hundred thirty three million two hundred forty seven thousand eight hundred ten dollars";
